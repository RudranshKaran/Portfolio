...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-b from-navy/50 to-background">
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 items-center py-20">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-text-secondary mb-8 max-w-2xl leading-relaxed">
